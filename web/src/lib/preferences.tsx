...
const messages = {
  "zh-CN": {
    ...
    doubleClickConnect: "双击或按 Enter 连接",
    noSession: "尚未打开会话",
    connectHint: "从侧边栏选择资产，双击或按 Enter 开始连接。",
    deleteAssetFailed: "删除连接失败",
    deleting: "正在删除…",
    expandSidebar: "展开侧边栏",
  ...
  en: {
    ...
    doubleClickConnect: "Double-click or press Enter to connect",
    noSession: "No open sessions",
    connectHint: "Choose an asset in the sidebar, then double-click or press Enter to connect.",
    deleteAssetFailed: "Failed to delete connection",
    deleting: "Deleting…",
